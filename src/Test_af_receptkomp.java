...
public class Test_af_receptkomp {
	...
	public void test() throws DALException {
		...
		try { rk.getReceptKompList().equals(nyliste); }
		catch (DALException e) {}
		...
		System.out.println("Vi ændrer på alle attributterne, så de i rækkefølge hedder 5,2,11.0,12.0");
		...
		System.out.println("Vi undersøger alle getterne");
