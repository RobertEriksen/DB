...
public class MySQLRaavareDAO implements RaavareDAO {
	...
	@Override
	public void createRaavare(RaavareDTO rv) throws DALException {
		Connector.doUpdate(
				"INSERT INTO raavare(raavare_id, raavare_navn, leverandoer) VALUES " +
				"(" + rv.getRaavareId() + ", '" + rv.getRaavareNavn() + "', '" + rv.getLeverandoer() + "')"
			);
	}

	@Override
	public void updateRaavare(RaavareDTO rv) throws DALException {
		Connector.doUpdate(
				"UPDATE raavare SET raavare_navn = '" + rv.getRaavareNavn() + "', leverandoer =  '" + rv.getLeverandoer() + 
				"' WHERE raavare_id = " + rv.getRaavareId()
		);
	}
